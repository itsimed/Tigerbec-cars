          ...
          <div className={`transform transition-all duration-800 delay-400 order-2 lg:order-1 ${
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-700/50 hover:border-red-500/30 transition-all duration-500 group">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Instagram */}
                <div className="flex items-start space-x-3 sm:space-x-4 group/item hover:transform hover:translate-x-2 transition-all duration-300">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600/20 rounded-lg flex items-center justify-center flex-shrink-0 group-hover/item:bg-purple-600/40 transition-all duration-300">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400 group-hover/item:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1 group-hover/item:text-purple-400 transition-colors duration-300 text-sm sm:text-base">
                      Instagram
                    </h4>
                    <a 
